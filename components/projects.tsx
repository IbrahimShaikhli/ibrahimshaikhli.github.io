      ...
      <div className="container mx-auto px-4">
            ...
            <div key={project.id} className="bg-gray-900 rounded-xl p-6 border border-gray-800">
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="flex items-center gap-1 text-sm text-purple-500"
                  target="_blank"
        ...
        <div className="text-center mt-12">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="border border-purple-600 text-purple-500 font-bold py-2 px-6 rounded-full inline-block"
          >
